    ...
    async getChildren(element) {
        ...
        if (!element) {
            ...
            if (vscode.workspace.workspaceFolders && vscode.workspace.workspaceFolders.length > 0) {
                ...
                items.push(new TemplateTreeItem(path.basename(currentFolder), vscode.TreeItemCollapsibleState.Expanded, currentFolder, false, true));
            }
            // Add a separator
            items.push(new TemplateTreeItem('Available Templates', vscode.TreeItemCollapsibleState.None, '', false, false, 'category'));
            // Get all templates
        ...
        if (fs.existsSync(element.templatePath)) {
            return fs.readdirSync(element.templatePath, { withFileTypes: true })
                ...
                return new TemplateTreeItem(entry.name, isFile ? vscode.TreeItemCollapsibleState.None : vscode.TreeItemCollapsibleState.Collapsed, itemPath, isFile, false, isFile ? 'file' : 'folder');
            });
        }
        return [];
    }
