...
try:
    ...
    HAS_PATHSPEC = False
    print("💡 Tip: Install 'pathspec' for better .gitignore support: pip install pathspec")
...
class TodoFinder:
    ...
    def _load_gitignore(self):
        ...
        if not gitignore_path.exists():
            print("📝 No .gitignore file found, using default ignore patterns")
            return
        ...
        try:
            ...
            if HAS_PATHSPEC:
                ...
                print(f"✅ Loaded .gitignore with pathspec support")
            else:
                ...
                print(f"✅ Loaded .gitignore with {len(self.gitignore_patterns)} patterns (basic support)")
    ...
    def find_todos(self) -> List[Dict]:
        ...
        print(f"🔍 Searching for TODOs in: {self.root_path}")
